  ...
  return (
    <div className="min-h-screen bg-[#f7f7f4] text-slate-900">
      ...
      <main id="top">
        ...
        <section id="contact" className="border-t border-slate-900/10 bg-[#e8f4f4] px-5 py-16 sm:px-8"><div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1fr_auto] md:items-end"><div><p className="eyebrow mb-3 text-cyan-800">Contact</p><h2 className="max-w-none font-display text-4xl font-bold">Interested in trustworthy and scientific machine learning?</h2><p className="mt-4 max-w-2xl leading-7 text-slate-600">I welcome conversations about research collaborations, academic opportunities, and machine learning for complex scientific problems.</p></div><a href="mailto:jinsuhong.knight@gmail.com"><Button className="bg-slate-900 px-5 text-white hover:bg-slate-700"><Mail className="mr-2 h-4 w-4" />Get in touch</Button></a></div></section>
      </main>
